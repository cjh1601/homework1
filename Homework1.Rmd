...
Steps to follow:  
1. Post on class discussion board any questions on the code that you don't understand.   
...
### Q1. Why might the same command give different output?  Please explain why the following code creates two different histograms.
...
### Q2: Modify the code below so that the same figure is plotted twice.
